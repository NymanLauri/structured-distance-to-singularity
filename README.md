...
L. Nyman. “Singular vector spaces for computing the structured distance to singularity”, 2026, [arXiv](https://arxiv.org/abs/2603.01233)
...
The file ``svdmin.m``, written by Ethan N. Epperly, Yuji Nakatsukasa and Taejun Park, is based on the work "Fast, High-Accuracy, Randomized Nullspace Computations for Tall Matrices", 2026, [arXiv](https://arxiv.org/abs/2602.16797)
